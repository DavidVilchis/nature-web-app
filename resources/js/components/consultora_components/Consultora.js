...
const Consultora = () => {
    return (
        ...
        <Navigation />
            <Container fluid>
                <Row className="row-background-consultora">
                    <Col xs={12} md={12} xl={6} className="col-background-style">
                        <center>
                            <h1 className="h1-title-page">CONSULTORA</h1>
                            <h2 className="h2-subtitle-page">Se parte de <b>Natur<label className="label-color-nature">é</label></b></h2>
                        </center>
                    </Col>
                    <Col xs={12} md={12} xl={6} className="col-background-style">
