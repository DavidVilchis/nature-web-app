...
const Pedidos = () => {
    ...
    const handleSubmitAgregar = async (e) => {
        ...
        axios.post(
            "http://localhost/nature-web-app/public/api/pedidos_store_id", formData, { headers }
        ).then(response => {
    ...
    const handleSubmitUpdateAgregar = async (e) => {
        ...
        axios.post(
            "http://localhost/nature-web-app/public/api/pedidos_update_id", formData, { headers }
        ).then(response => {
            if (response.data.missing == "true") {
                swal({
        ...
        const borrar = () => {
            swal({
                ...
                if (response) {
                    ...
                    axios.post(
                        "http://localhost/nature-web-app/public/api/pedidos_destroy_id", formData, { headers }
                    ).then((responseDelete) => {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            axios.post("http://localhost/nature-web-app/public/api/pedidos_index_id", formData, { headers }
            ).then((response) =>{
                console.log(response.data);
                setTabla(response.data);
            })
